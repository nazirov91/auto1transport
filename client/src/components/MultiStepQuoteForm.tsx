        ...
        <form onSubmit={handleSubmit}>
          ...
          {currentStep === 3 && (
            <div className='space-y-4'>
              ...
              {/** Add checkbox for privacy agreement **/}
              <div className='space-y-2'>
                <div className='flex items-center space-x-2'>
                  <input
                    type='checkbox'
        ...
        <AlertDialogContent className='sm:max-w-lg'>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className='text-black-700'>
              Hi {submittedData?.stepThree.firstName}! Your personalized quote for the{' '}
              {submittedData?.stepTwo.year} {submittedData?.stepTwo.make}{' '}
              {submittedData?.stepTwo.model} will be sent to {submittedData?.stepThree.email} within
              seconds! Our auto transport specialists are already working on your competitive rate!
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogAction
